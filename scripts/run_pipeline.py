...
def main(questions):
    ...
    try:
        ...
        for question in questions:
            ...
            # Если задача включает математические расчеты, приводи всю информацию (например, ставка ндфл рассчитывается прогрессивно, но при математических расчетах ты часто ошибаешься, поэтому надо привести всю таблицу ставок)
